...
container_client = ContainerClient.from_connection_string(conn_str="DefaultEndpointsProtocol=https;AccountName=trialstoragejman;AccountKey=CmpVbbBd/B3powxm3hsccTbxUJIW5k4yufJ/mFz828fMjzFP0+SKg9nDL8ZQIwHmfETcaeaFgBrv+AStwC7oiA==;EndpointSuffix=core.windows.net", container_name="lenskartdata/Source")
